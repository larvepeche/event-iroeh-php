<section class="p-4 mt-5 thankyou">
    <?php 
        ...
        if(isset($member)){ ?>
            ...
            <h5>Veuillez valider votre inscription en payant la somme prévue dans les <strong>48h qui suivent</strong>. </h5>
            <h5 class="price">Tarif : <strong><?= $price ?> MGA</strong></h5>
            <hr/>
